  ...
  return (
    <HomeLayout>
      ...
      <Row>
        <Col
          span={12}
          style={{ width: "100%", height: "150px", lineHeight: "2.0" }}
        >
          <div style={{ paddingTop: "15px" }}>
            ...
            <Col style={{ fontSize: "15px", fontWeight: "600" }}>
              Thuong Thuy, Phu Phuong, Tay Ho, Ha Noi
            </Col>
          </div>
        </Col>
        <Col span={12}>
          ...
          <Col span={12} style={{ paddingTop: "15px", lineHeight: "3.0" }}>
            <Col style={{ fontWeight: "600", fontSize: "15px" }}>
              The order has been placed{" "}
            </Col>
            <Col style={{ fontSize: "15px", fontWeight: "600" }}>
              The order has been placed successfully shipped
            </Col>
          </Col>
        </Col>
      </Row>
