    ...
    <HomeLayout>
          ...
          <div>
            <div>
              <Row>
                ...
                <h6 style={{ color: "blue" }}>campaign.productBrand</h6>
              </Row>
            </div>
            ...
            <div>
              <Row style={{ display: "flex", alignItems: "center" }}>
                ...
                <h4>Sold {campaign.soldQuantity}</h4>
              </Row>
            </div>
            <div>
              <Row style={{ alignItems: "end", display: "flex" }}>
                <Col
                  ...
                  span={8}
                >
                  {/* <h2>{campaign.levels[0].price} đ</h2>{" "} */}
                </Col>
                <Col style={{ textDecoration: "line-through" }}>
                  {" "}
                  <h4> {campaign.currentPrice} đ</h4>
                </Col>
              </Row>
            </div>
            <div>
      ...
      <Row style={{ height: "200px", paddingTop: "40px" }}>
        ...
        <Row style={{ width: "100%", paddingTop: "20px" }}>
          ...
          >
            <div>{campaign.productCategory}</div>
            <div>Việt Nam</div>
